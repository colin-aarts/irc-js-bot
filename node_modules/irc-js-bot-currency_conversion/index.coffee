	...
	@register_special_command
		...
		fn: (event, input_data, output_data) =>
			...
			if '?' in input_data.flags
				...
				message = "Insifficient arguments specified for currency conversion command. See #{input_data.trigger}$/? for details."
			else
				...
				if not args_match
					...
					await convert from, to, amount, defer err, result
