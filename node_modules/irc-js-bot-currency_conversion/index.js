  ...
  module.exports = function() {
    ...
    return this.register_special_command({
      ...
      fn: function(event, input_data, output_data) {
        var amount, api_key, args_match, err, from, message, result, to, ___iced_passed_deferral, __iced_deferrals, __iced_k, _ref, _ref1;
        __iced_k = __iced_k_noop;
        ___iced_passed_deferral = iced.findDeferral(arguments);
        api_key = (_ref = _this.bot_options.plugin_options) != null ? (_ref1 = _ref['irc-js-bot-currency_conversion']) != null ? _ref1.api_key : void 0 : void 0;
        if (!api_key) {
          _this.log.warning("" + _this.log.prefix + " API key for plug-in « irc-js-bot-currency_conversion » not found");
          return;
        }
        (function(__iced_k) {
          if (__indexOf.call(input_data.flags, '?') >= 0) {
            ...
            (function(__iced_k) {
              if (!input_data.args) {
                return __iced_k(message = "Insufficient arguments specified for currency conversion command; see " + input_data.trigger + "$/? for details");
              } else {
