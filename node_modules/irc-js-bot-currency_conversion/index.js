...
(function() {
  ...
  var api_key, convert, http, iced, shorten, util, __iced_k, __iced_k_noop,
    __slice = [].slice,
  ...
  module.exports = function() {
    ...
    return this.register_special_command({
      ...
      fn: function(event, input_data, output_data) {
        var amount, args_match, err, from, message, result, to, ___iced_passed_deferral, __iced_deferrals, __iced_k;
                  ...
                  if (!args_match) {
                    ...
                    (function(__iced_k) {
                      __iced_deferrals = new iced.Deferrals(__iced_k, {
                        ...
                        filename: "node_modules\irc-js-bot\node_modules\irc-js-bot-currency_conversion\index.coffee",
                        funcname: "fn"
                      });
                      convert(from, to, amount, __iced_deferrals.defer({
                        assign_fn: (function() {
                          return function() {
                            err = arguments[0];
